...
class CreateUnidadesTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('unidades', function (Blueprint $table) {
            ...
            //adicionar o relacionamento com a tabela produtos (Relacionamento um para muitos)
    ...
    public function down()
    {
        ...
        //remover o relacionamento com a tabela produtos (Relacionamento um para muitos)
        Schema::table('produtos', function(Blueprint $table){
            //remover a fk
